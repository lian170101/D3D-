...
bool Setup()
{
	...
	if(mtrlBuffer != 0 && numMtrls != 0)
	{
		...
		D3DMATERIAL9 cyanMtrl = d3d::CYAN_MTRL;
		...
		mtrls2.push_back(cyanMtrl);
		mtrls2.push_back(blueMtrl);
		mtrls2.push_back(redMtrl);
		mtrls2.push_back(greenMtrl);
		mtrls2.push_back(yellowMtrl);
